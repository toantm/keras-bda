...
if __name__ == '__main__':
    ...
    lenet.compile(loss="categorical_crossentropy", optimizer='adadelta',
                  metrics=["accuracy"])
    ...
    for epoch in range(nb_epochs):
        ...
        lenet_test_loss = lenet.evaluate(X, aux_y, verbose=False)
        ...
        train_history['lenet'].append(lenet_train_loss)

        test_history['generator'].append(generator_test_loss)
        test_history['discriminator'].append(discriminator_test_loss)
        test_history['lenet'].append(lenet_test_loss)
